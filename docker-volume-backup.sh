...
docker container create --name nginxbackup --mount "type=bind,source=/Users/guest1/Documents/Coding/Docker/belajar-docker-dasar/backup,destination=/backup" --mount "type=volume,source=mongovolume,destination=/data" nginx:latest
